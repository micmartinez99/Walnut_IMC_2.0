# The purpose of this script is to regenerate some of the figures for the walnut manuscript using data generated by Pratik Mehta and Dr. Marmar Moussa
# I am not entirely sure if this is the proper spe object but this is the best I can find on the cluster in pratik's folders so we are going to roll with it.
